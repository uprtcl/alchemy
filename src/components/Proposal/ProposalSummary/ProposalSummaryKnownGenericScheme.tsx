  ...
  public render() {
        ...
        <div className={proposalSummaryClass}>
          ...
          {detailView ? (
            <div className={css.summaryDetails}>
              to contract at{" "}
              <a href={linkToEtherScan(proposal.genericScheme.contractToCall)}>
                {proposal.genericScheme.contractToCall.substr(0, 8)}...
              </a>
    ...
    return (
      <div className={proposalSummaryClass}>
        ...
        {detailView ? (
          <div className={css.summaryDetails}>
            Calling function {decodedCallData.action.abi.name} with values{" "}
            {decodedCallData.values.map((value: any) => (
